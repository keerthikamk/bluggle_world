...
(function($) {
  ...
  document.addEventListener("DOMContentLoaded", function() {
    const text = "Book your free no-obligation a 30 minute session.";
    ...
    function typeWriter() {
      ...
      function addNextChar() {
        if (i < text.length) {
          ...
          // Typing complete, reset animation
          setTimeout(typeWriter, 1000); // Wait 2 seconds before restarting
        }
      }
      addNextChar();
    }
  ...
  document.addEventListener("DOMContentLoaded", function() {
    const text = "Where Medical Minds Meet and Miracles Begin..";
    const speed = 50; // Typing speed in milliseconds
    const typingText = document.querySelector('.typing-text-2');
  ...
  document.addEventListener("DOMContentLoaded", function() {
    const text = "Empowering Your Vision, One Solution at a Time...";
    const speed = 50; // Typing speed in milliseconds
    const typingText = document.querySelector('.typing-text-3');
